package br.com.anteros.iot.support.weatherstation;
...
import br.com.anteros.iot.support.i2c.adc.ADS1x15;
import br.com.anteros.iot.support.sensor.BMP180;
import br.com.anteros.iot.support.sensor.HTU21DF;
			...
			this.pinAnem.addListener(new GpioPinListenerDigital() {
				...
				public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
					...
					if (event.getState().isHigh() && (nowMilliSec - lastWindMilliSecPing) > minimumDebounceTimeMilliSec) {
						long nowMicroSec = currentTimeMicros();
...
//							}
	...
	public float getCurrentWindDirection() {
		double direction = voltageToDegrees(getCurrentWindDirectionVoltage(), this.currentWindDirection);
		if (verbose || verboseWind) {
