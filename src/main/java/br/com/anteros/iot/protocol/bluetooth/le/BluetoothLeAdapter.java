...
import br.com.anteros.iot.protocol.ble.exceptions.BluetoothDiscoveryException;
...
public interface BluetoothLeAdapter {
     ...
     * 
     * @throws BluetoothDiscoveryException
     */
    public void stopDiscovery() throws BluetoothDiscoveryException;
     ...
     * @throws BluetoothRemoveException
     * 
     * @since 2.0
     */
    public int removeDevices() throws BluetoothRemoveException;
