...
public interface BluetoothGatt {
     ...
     */
    public boolean connect() throws BLEException;
     ...
     * @since 1.0.8
     */
    public boolean connect(String adapterName) throws BLEException;
     ...
     * @return If connection was successful
     */
    public boolean checkConnection() throws BLEException;
     ...
     */
    public String readCharacteristicValue(String handle) throws BLEException;
     ...
     * @return Characteristic value
     */
    public String readCharacteristicValueByUuid(UUID uuid) throws BLEException;
     ...
     * @since 1.2
     */
    public BluetoothGattSecurityLevel getSecurityLevel() throws BLEException;
