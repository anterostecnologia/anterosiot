...
import br.com.anteros.iot.protocol.bluetooth.listener.BluetoothAdvertisementScanListener;
...
public interface BluetoothAdapter {
     ...
     * data is relayed through the {@link br.com.anteros.iot.protocol.bluetooth.listener.BluetoothAdvertisementScanListener} as it
     * arrives.
     *
     * @param companyName
